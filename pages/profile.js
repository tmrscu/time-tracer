...
const Profile = ({ user }) => {
  ...
  // Used to open the delete profile dialog
...
// Alert Dialog Function to delete a user profile
      ...
      <AlertDialog
        ...
        <AlertDialogOverlay>
          <AlertDialogContent>
            ...
            <AlertDialogBody>
              Deleting your profile will delete all client, project and task
              data you have created. This cannot be undone, are you sure you
              wish to delete your profile and user data?
            </AlertDialogBody>
...
// Get serverside Props to check if user session exists
